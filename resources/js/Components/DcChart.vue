...
const props = defineProps({
  ...
  selectableData: {
    ...
    default: () => ({
      ...
      'ja-election-tokyo-gubernatorial-2024.jpg': 'ja-election-tokyo-gubernatorial-2024.csv',
      'ja-election-sangiin-2025.jpg': 'ja-election-sangiin-2025.csv',
      'ja-election-shugiin-2024.jpg': 'ja-election-shugiin-2024.csv',
...
const initChartDate = chartDateW => {
  ...
  mm.composite
    ...
    .brushOn(false)
    .elasticY(mm.opt.chartDate.elasticY) //yAxisの高さを動的に変化させる
