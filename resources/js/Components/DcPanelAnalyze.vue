...
<template>
  ...
  >
      ...
      <table id="tbl_ana" border="1" bordercolor="#b0b0b0" style="float: left">
        ...
        <tbody>
          <tr>
            <td>
              全国 第1波(前半)<br /><a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&date=2020-03-16+2020-04-19&light=1`"
                @click="handleWopenClick"
                >3/15(日)～4/19(日)</a
              >
            </td>
            <td>
              <div class="diff wopen ui-button ui-corner-all ui-widget" @click="handleWopenClick">
                <span class="ui-icon ui-icon-arrow-2-e-w ic_btn"></span>比較
              </div>
            </td>
            <td>
              全国 第2波(前半)<br /><a
          ...
          <tr>
            <td>
              <div class="diff wopen ui-button ui-corner-all ui-widget" @click="handleWopenClick">
                <span class="ui-icon ui-icon-arrow-2-n-s ic_btn"></span>比較
              </div>
            </td>
            <td></td>
            <td>
        ...
        <tbody>
          <tr>
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&q=福岡市&light=1`"
                @click="handleWopenClick"
                >福岡市</a
              >
            </td>
            ...
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&q=北九州市&light=1`"
                @click="handleWopenClick"
                >北九州市</a
              >
            </td>
          ...
          <tr>
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&q=札幌市&light=1`"
                @click="handleWopenClick"
                >札幌市</a
              >
            </td>
            ...
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&q=旭川市&light=1`"
                @click="handleWopenClick"
                >旭川市</a
              >
            </td>
          ...
          <tr>
            <td>
              東京都隣接県A<br /><a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&name=埼玉県&light=1`"
                @click="handleWopenClick"
                >埼玉県</a
              >
            </td>
            ...
            <td>
              東京都隣接県B<br /><a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&name=神奈川県&light=1`"
                @click="handleWopenClick"
                >神奈川県</a
              >
            </td>
          ...
          <tr>
            <td>
              大阪府隣接県A<br /><a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&name=兵庫県&light=1`"
                @click="handleWopenClick"
                >兵庫県</a
              >
            </td>
            ...
            <td>
              大阪府隣接県B<br /><a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&name=京都府&light=1`"
                @click="handleWopenClick"
                >京都府</a
              >
            </td>
        ...
        <tbody>
          <tr>
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&q=学生&light=1`"
                @click="handleWopenClick"
                >学生</a
              >
            </td>
            ...
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&q=医療従事者&light=1`"
                @click="handleWopenClick"
                >医療従事者</a
              >
            </td>
          ...
          <tr>
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&q=社会人&light=1`"
                @click="handleWopenClick"
                >社会人</a
              >
            </td>
            ...
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&q=介護職員&light=1`"
                @click="handleWopenClick"
                >介護職員</a
              >
            </td>
          ...
          <tr>
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&name=福岡県&q=学生&light=1`"
                @click="handleWopenClick"
                >福岡県 学生</a
              >
            </td>
            ...
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&name=福岡県&q=医療従事者&light=1`"
                @click="handleWopenClick"
                >福岡県 医療従事者</a
              >
            </td>
          ...
          <tr>
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&name=北海道&q=学生&light=1`"
                @click="handleWopenClick"
                >北海道 学生</a
              >
            </td>
            ...
            <td>
              <a
                class="wopen ui-button ui-corner-all ui-widget"
                :href="`${options.href}&name=北海道&q=医療従事者&light=1`"
                @click="handleWopenClick"
                >北海道 医療従事者</a
              >
            </td>
    ...
    <ul>
      <li>
        <span class="wopen ui-icon ui-icon ui-icon-arrow-2-e-w sp_icon"></span>&nbsp;<span
          class="wopen ui-icon ui-icon ui-icon-arrow-2-n-s sp_icon"
        ></span>
        の比較ボタンをクリックすると比較用にウインドウが左右２つ開きます。<b
          ><a
            tt_title="WEBブラウザの設定によってウインドウの複数オープンがブロックされている場合があります。<br /><img src='/img/hlp/popupblock_chrome.gif'><br /><br />以下の操作で設定の変更が可能です。<br />1.アドレスバーの右上にあるをクリック<br />2.「http://***のポップアップを常に許可する」にチェックを入れる"
            >※開かない時</a
          ></b
        >
      </li>
      <li>
        このサイトのURLのパラメタについては<b
          ><a
            tt_title="■URLの例<br />福岡県 の状況の場合<br />https://sakanaclub.xsrv.jp/dc/covid19/name=福岡県<br /><br />福岡県 4/4(月)～5/2(土) 職業:看護師 の状況の場合<br />https://sakanaclub.xsrv.jp/dc/covid19/name=福岡県&date=4-4+5-2&q=看護師<br /><br />■パラメタの説明<br />＊name: 都道府県<br />例 name=福岡県<br />   name=福岡県+佐賀県  ...複数形式<br /><br />＊date: 日付<br />例 date=4-11     ...単一日形式  4月11日<br />　 date=4-4+5-8  ...範囲日形式  4月4日~5月8日<br />　 date=4-4+14   ...範囲日形式2 4月4日 + 14days<br /><br />＊q: 検索キーワード (市区町村・職業・状態等のキーワード)<br />例 q=北九州市 ...市区町村<br />　 q=看護師　 ...職業等<br />"
            >こちらを参照</a
          ></b
        >
      </li>
