...
/*
customize resources/js/Shared/FlashMessages.vue:29 @pingcrm to vue3 typescript
  ...
  <div>
    ...
    >
      <div class="flex items-center">
        ...
        <div v-if="page.props.flash.error" class="py-4 text-sm font-medium text-white">
