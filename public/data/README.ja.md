...
- **フォーマット**:
  ```
  日付,性別,年齢,政党,都道府県,立候補者名,職業,職業カテゴリ(未使用),議席数,当選・落選,得票数,得票率(%),職業カテゴリ,選挙制度,小選挙区,前・元・新,当選回数,推薦,🔖Q.消費税減税,🔖Q.対米外交,🔖Q.原子力発電の依存度 等
  ```
...
- **フォーマット**:
  ```
  日付,性別,年齢,政党,都道府県,立候補者名,職業,議席数,得票数,得票率(%),選挙制度,小選挙区,前・元・新,当選回数 等
  ```
...
- **飲料評価データ**: `test-drink.csv`
  ...
  - **フォーマット**:
    ```
    日付,性別,年齢,評価,都道府県,商品名,職業,未使用,販売本数,メーカー/種別,メーカー,❄️クール/🔥ホット,種別
    ```
